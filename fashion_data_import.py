...
def data_in(file_in):
    ...
    if file_in == 'train':
        data = pd.read_csv("/home/wataru/machineLearn/fashionmnist/fashion-mnist_train.csv")

    elif file_in == 'test':
        data = pd.read_csv("/home/wataru/machineLearn/fashionmnist/fashion-mnist_test.csv")
