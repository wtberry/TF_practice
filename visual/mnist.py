...
LOGDIR = '/home/wataru/machineLearn/kaggle/TF_practice/visual/log/'
...
ur.urlretrieve(GIST_URL + '/labels_1024.tsv', LOGDIR + 'labels_1024.tsv')
ur.urlretrieve(GIST_URL + '/sprite_1024.png', LOGDIR + 'sprite_1024.png')
